...
public class LeftAutoScale extends CommandGroup {
	public LeftAutoScale() {
		...
		addSequential(new DriveFor(() -> Direction.fromChar(Robot.gameData.charAt(1)), (dir) -> dir == Direction.LEFT ? -210 : -50, -0.75));
		...
		addSequential(new DriveFor(() -> Direction.fromChar(Robot.gameData.charAt(1)), (dir) -> dir == Direction.LEFT ? -26 : 0, -0.5));
		// Moves the robot forward above the switch if the switch is our color
		addSequential(new DriveFor(() -> Direction.fromChar(Robot.gameData.charAt(0)), (dir) -> dir == Direction.LEFT ? -26 : 0, -0.5));
//		addSequential(new DriveFor(-26, -0.5));
		...
		addSequential(new DriveFor(() -> Direction.fromChar(Robot.gameData.charAt(1)), (dir) -> dir == Direction.LEFT ? 24 : 0, 0.35));
		// Moves the robot backward if the switch is our color
//		addSequential(new DriveFor(() -> Direction.fromChar(Robot.gameData.charAt(0)), (dir) -> dir == Direction.LEFT ? 24 : 0, 0.35));
//		addSequential(new DriveFor(24, 0.25));
	}
}
